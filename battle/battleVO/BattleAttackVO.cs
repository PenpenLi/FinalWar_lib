...
namespace FinalWar
{
    public struct BattleAttackVO
    {
        ...
        public BattleAttackVO(int _pos, int _attacker, int _defender, int _damage, List<BattleHeroEffectVO> _attackerEffectList, List<BattleHeroEffectVO> _defenderEffectList)
        {
            pos = _pos;
            attacker = _attacker;
            defender = _defender;
